            ...
            <Form className="form welcome">
                <div className="upperForm">
                    ...
                    {transition((style, item) =>
                        <animated.h2 style={style}>Welcome</animated.h2>
                    )}
                </div>
                {transition2((style, item) =>
                    <animated.div style={style} className="welcomeParagraph">
                        ...
                        <p>
                            ...
                            <span style={{ color: "red", fontSize: "1.5rem"}}> times of flood risk.</span></p>
                        <p>You will play in a group together with <span style={{ color: "red", fontSize: "1.5rem" }}>four other REAL people.</span> </p>
                    </animated.div>
                )}
