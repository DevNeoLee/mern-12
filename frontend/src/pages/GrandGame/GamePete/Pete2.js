...
export default function Pete2({ userTaskDoneCounter, globalGame, setGlobalGame, globalSession, setGlobalSession, data, handleChangeWhichRoutePete, whichRoutePete, handleChangePetePower, handleSubmitPete, popForm, setPopForm, messageFromErica, round, electricity, messageToPete, step, normanQuestion, petePower, peteHealth }) {

    const [hover1, setHover1] = useState(false);
    const [hover2, setHover2] = useState(false);
    const [hover3, setHover3] = useState(false);
    const [hoverSH, setHoverSH] = useState(false);
                ...
                <div className="leftContainer">
                    ...
                    <div className="gameBlock1" >
                        ...
                        <div className="powerStatusPete">
                            {/* <div className="lightning1"> <LightningFill size={100} /></div> */}
                            <div className="lightning2"> <LightningFill size={100} /></div>
                            <div className="lightning3"> <LightningChargeFill size={50} onMouseEnter={handleMouseEnter4} onMouseLeave={handleMouseLeave4}/></div>
                            <div className="powerStation"><HospitalFill className={electricity ? `bighouse on` : 'bighouse off'} size={280}/></div>
                            <div className="poweronPete">
                                <span>Electricity</span>
                                {electricity ? <span>{' '}Generating</span> : <span>No More</span>}
                            </div>
                        </div>
                        <div className="cloudRain">
                        ...
                        {/* <div className="mp3Rain1">
                            <video controls loop>
                                <source src="/cloud2.mp4" type="video/mp4" />
                                Your browser does not support the video tag.
                            </video>      
                        </div> */}
                        {/* <video src="/cloud2.mp4"></video> */}
                    </div>
                </div>
                <div className="rightContainer">
                    ...
                    <div className="gameBlock">
                        ...
                        <div className="normanMapContainer">
                            ...
                            <div className="arrow1" onMouseEnter={handleMouseEnter1} onMouseLeave={handleMouseLeave1}> <img src="/redarrow.png" alt="arrow1" width="90px" /><img src="/redarrow.png" alt="arrow1" width="90px" /></div>
                            <div className="arrow2" onMouseEnter={handleMouseEnter2} onMouseLeave={handleMouseLeave2}><img src="/redarrow.png" alt="arrow2" width="90px" /><img src="/redarrow.png" alt="arrow2" width="90px" /><img src="/redarrow.png" alt="arrow2" width="90px" /></div>
                    ...
                    <div className="bottomContainer">
                        <div className="gameBlock5 peteColor">
